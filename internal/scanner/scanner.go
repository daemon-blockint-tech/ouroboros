...
import (
	...
	"github.com/daemon-blockint-tech/ouroboros/internal/ecosystem/browserext"
	"github.com/daemon-blockint-tech/ouroboros/internal/ecosystem/bun"
	"github.com/daemon-blockint-tech/ouroboros/internal/ecosystem/composer"
	"github.com/daemon-blockint-tech/ouroboros/internal/ecosystem/editorext"
	"github.com/daemon-blockint-tech/ouroboros/internal/ecosystem/gomod"
	"github.com/daemon-blockint-tech/ouroboros/internal/ecosystem/mcp"
	"github.com/daemon-blockint-tech/ouroboros/internal/ecosystem/npm"
	"github.com/daemon-blockint-tech/ouroboros/internal/ecosystem/pnpm"
	"github.com/daemon-blockint-tech/ouroboros/internal/ecosystem/pypi"
	"github.com/daemon-blockint-tech/ouroboros/internal/ecosystem/rubygems"
	"github.com/daemon-blockint-tech/ouroboros/internal/ecosystem/yarn"
	...
	"github.com/daemon-blockint-tech/ouroboros/internal/walk"
)
...
type Config struct {
	...
	// OnPackageObserved, when set, is called for each deduplicated package
	// record accepted in the run (before emission). Used by ouroboros agent
	// for SQLite persistence without changing stdout/file/http sinks.
	OnPackageObserved func(model.Record) error
}
...
func Run(ctx context.Context, cfg Config) (Result, error) {
	...
	emit := func(r model.Record) {
		...
		if cfg.OnPackageObserved != nil {
			if err := cfg.OnPackageObserved(r); err != nil {
				setEmitErr(fmt.Errorf("on package observed: %w", err))
				return
			}
		}
		if cfg.Catalog != nil {
