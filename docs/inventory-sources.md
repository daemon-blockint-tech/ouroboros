...
on disk, what `ouroboros` reads, and what it deliberately does not.
...
and ouroboros never executes anything during the scan.
...
- No bundled threat intelligence. Ouroboros ships no built-in advisory
