...
Curated exposure catalogs for recent supply-chain campaigns, built from
public threat-intelligence reporting. Entries are maintained via pull
request as new campaigns are documented in the open literature.
